module github.com/2ttech/terraform-provider-sealed-secret
...
require (
	...
	github.com/kita99/terraform-provider-kubeseal v1.0.0
)
...
require (
	...
	github.com/bitnami-labs/sealed-secrets v0.16.0 // indirect
